...
import com.dechain.depay.ApiListField;
...
public class JSONWriter {
    ...
    private void date(Date date) {
        if (this.format == null) {
            this.format = new SimpleDateFormat(DePay.DATE_TIME_FORMAT);
            this.format.setTimeZone(TimeZone.getTimeZone(DePay.DATE_TIMEZONE));
        }
        add("\"");
