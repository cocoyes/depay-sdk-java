...
public class RequestOptions {
    ...
    public static RequestOptions getDefault(String uri, String version) {
        return new RequestOptions(
                uri,
                version,
                DePay.DEFAULT_SIGN_TYPE,
                DePay.appId,
                DePay.apiKey,
                DePay.getConnectTimeout(),
                DePay.getReadTimeout(),
                DePay.getMaxNetworkRetries(),
                DePay.getAcceptLanguage());
    }
    ...
    public static class RequestOptionsBuilder {
        ...
        public RequestOptionsBuilder() {
            this.signType = DePay.DEFAULT_SIGN_TYPE;
            this.appId = DePay.appId;
            this.apiKey = DePay.apiKey;
            this.connectTimeout = DePay.getConnectTimeout();
            this.readTimeout = DePay.getReadTimeout();
            this.maxNetworkRetries = DePay.getMaxNetworkRetries();
            this.acceptLanguage = DePay.getAcceptLanguage();
        }
